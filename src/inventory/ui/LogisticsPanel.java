...
public class LogisticsPanel extends JPanel {
    ...
    public LogisticsPanel(InventoryService inventoryService) {
        ...
        // 1. Task List First (Manager's Priority)
    ...
    private JPanel createRestockRecommendationPanel() {
        ...
        listTitle.setForeground(Color.DARK_GRAY);
        ...
        if (listModel.isEmpty()) {
            listModel.addElement("  All stock levels healthy.");
        }
    ...
    // Inner class for the bar charts
